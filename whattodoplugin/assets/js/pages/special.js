var specials_calendar_app = angular.module('specialsCalendarApp', ['ngMaterial']);

specials_calendar_app.controller('calendarCtrl', function($scope, $mdDialog, $anchorScroll){
	$scope.progress = true;
	...
	showDateDialog = function(ev, timestamp){
		...
		jQuery.ajax({
			...
			url: wtd_ajax_url,
			data: {
				action: 'get_specials_date_dialog',
				timestamp: timestamp,
				res_id: res_id
			},
			success: function(data){
