                ...
                if (in_array($post->ID,$wtd_pages['calendar_pages'])){
					...
					<script>
                        ...
                        function wtd_get_month(start, end, year, month){
                            ...
                            Parse.Cloud.run('events_calendar_short', base_request, {
                                success: function (result) {
                                    jQuery.ajax({
                                        ...
                                        success: function(data){
                                            ...
                                            jQuery('#wtd_events #dates').html(data.html);
                    ...
                    <div class="row" id="calendar_controler">
                        <a href="javascript:void(0);" id="prev_month" class="get_month" data-start="<?php echo $prev_start;?>" data-end="<?php echo $prev_end;?>" data-month="<?php echo $prev_month;?>" data-year="<?php echo $prev_year;?>"><?php echo $prev_month_name;?></a>
                        ...
                        <div class="contents">
                            <div class="wtd_row"><?php
                                ...
                                <a href="<?php echo $event_url;?>" title="<?php echo $row->name; ?>">
                                    ...
                                    <span class="wtd_event_modal"><?php echo $row->name; ?><br/><?php echo $row->vendor; ?></span>
                                    </a><?php
                                    $j++;
                                }?>
                            </div>
