...
class wtd_week_page{
    ...
    public function content($content){
        ...
        if (!empty($wtd_plugin['week_options'][$res_id]))
            foreach ($wtd_plugin['week_options'][$res_id] as $cat_id => $cat){
                if (!empty($cat['parent']))
                    $exclude[] = $cat_id;
        ...
        <?php
            ...
            $args = array(
                ...
                'meta_query' => array(
                    array(
                        'key' => 'eve_date',
                        'value' => array( date('Y-m-d',$current_timestamp), date('Y-m-d',$week_time) ),
                        'compare' => 'BETWEEN'
                    )
                ),
                'tax_query' => array(
                    ...
                    <div class="wtd_listing_container <?php echo $masonry_item;?>">
                        <div class="wtd_listing_sc_listing_list">
                            <div class="wtd_listing_sc_top_content clearfix">
                                <?php
                                $listing_url = get_post_permalink($event->ID);
                                ...
                                <div class="wtd_listing_sc_imageArea">
                                    <a href="<?php echo $listing_url;?>">
                                        <img src="<?php echo WTD_IMG_BASE.$eve_thm;?>" alt="<?php echo $title;?>"/>
                                    </a>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <p><?php
                                                ...
                                                wtd_excerpt_generator($desc, $event);
                                                ?>
                                            </p>
                                            <p>Event Hosted by: <?php echo $vendor->post_title;?></p>
                                            <p class="wtd_week_date">
                                                <?php
                                                $time = strtotime($eve_date);
...
$wtd_week_page = new wtd_week_page();
?>