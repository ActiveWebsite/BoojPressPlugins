        ...
        if ($post->post_type == 'wtd_event'){
            ...
            $page_args = array(
                ...
                'meta_query' => array(
                    ...
                    array(
                        'key' => 'wtd_page',
                        'value' => array('calendar_page','week_page'),
                        'compare' => 'IN'
                    )
                )
            );
                            ...
                            <div class="wtd_single_event_sc_left_content">
                                <ul>
                                    ...
                                    <?php if (!empty($eve_web)): ?>
                                        <li class="expireBig">
                                            <a href="<?php  echo (substr_count($eve_web,'http://')) ? $eve_web : 'http://'.$eve_web;?>" target="_blank"><?php echo $eve_web;?></a>
                                        </li>
                                    <?php endif; ?>
                                    <li class="expireBig">
...
$wtd_single_event = new wtd_single_event();
