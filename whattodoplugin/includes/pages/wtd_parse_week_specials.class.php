...
if(!class_exists('wtd_parse_week_specials')){
	class wtd_parse_week_specials{
		public function __construct(){
			...
			//Page Content
			if(!empty($wtd_plugin['weekspecials-page']))
		...
		public function page_content($content){
			...
			if(!empty($wtd_pages['weekspecials_pages'][$res_id]) && $page_type == 'weekspecials_page')
				if(in_array($post->ID, $wtd_pages['weekspecials_pages'])){
		...
		public function content($res_id){
			...
			<script src="<?php echo WTD_PLUGIN_URL; ?>assets/js/pages/special_week.js"></script><?php
			wtd_copyright();
						...
						<div class="wtd_listing_sc_top_content"><?php
							...
							<div layout="row">
								...
								<div flex layout="column">
									...
									if(!empty($vendor)){?>
										<div>Special Hosted by: <?php echo $vendor; ?></div><?php
									}?>
