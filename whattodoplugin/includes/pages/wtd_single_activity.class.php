        ...
        if ($post->post_type == 'wtd_activity'){
            ...
            if ($page_query->found_posts):
                ...
                <div id="wtd_breadcrumb">
                    ...
                    <?php if (!empty($second)):?>
                        <span class="wtd_bread_separator">&gt;</span>
                        <a id="parent_<?php echo $second->term_id;?>_header" href="<?php echo get_post_permalink($back_page).'category/'.$second->slug;?>" class="wtd_pull_left"><?php
                            echo $second->name;?>
                        </a>
                    <?php endif;?>
                </div>
                    ...
                    <div class="wtd_listing_sc_listing_list">
                        <div class="wtd_listing_sc_top_content clearfix">
                            <div class="wtd_single_listing_sc_image" class="wtd_text_center"">
                                <img class="wtd_top_10" src="<?php echo WTD_IMG_BASE.get_post_meta($post->ID,'listing_img',true);?>" alt="Vendor Image"/>
                            </div>
                            <div class="wtd_single_listing_sc_left_content">
                                <?php
                                if(empty($first)){
                                    $first = $post_terms[0];
                                    if ($first->parent)
                                ...
                                <?php endif; ?>
                                        ...
                                        <?php if (!empty($video)): ?>
                                            <?php $wtd_video_id = wtd_video_id_generator($video);?>
                                    ...
                                    <?php if (!empty($addresses)):
                                        foreach ($addresses as $address):?>
                                            <p><?php
                                                    ...
                                                    if (!empty($address['lat']) && !empty($address['lng']))
                                                        $location_display .= ' - <a class="wtd_direction_link" target="_blank" href="https://maps.google.com/?saddr=%currlocation%&daddr='.$address['lat'].','.$address['lng'].'">View Directions</a>';
                                        ...
                                        <script>
                                            ...
                                            var visitor_lat;
                                            var visitor_lng;
                                            jQuery('.wtd_direction_link').click(function(e){
                                    ...
                                    <?php endif?>
                                    <?php if (!empty($listing_web)): ?>
                                        <p>
                                            <span class="expireBig"><a href="<?php echo (substr_count($listing_web,'http://')) ? $listing_web : 'http://'.$listing_web;?>" target="_blank"><?php echo $listing_web;?></a></span>
                                        </p>
                                    <?php endif?>
            ...
            if (count($images) > 0){?>
                <div id="wtd_act_gallery">
                    ...
                    <div id="wtd_gallery_big">
                        <?php
                            echo '<img src="'.WTD_IMG_BASE.$images[0]['url'].'"/>';
                        ?>
                    </div>
                    <div id="wtd_gallery_nav">
                        ...
                        foreach ($images as $key => $image) {
                            ...
                            echo '<a href="javascript:void(0);" class="' . $class . '" data-img="' . WTD_IMG_BASE . $image['url'] . '"><img src="' . WTD_IMG_BASE . $image['thumb'] . '"/></a>';
                        }
                        ?>
                    </div>
                </div>
...
$wtd_single_activity = new wtd_single_activity();
