...
if(!class_exists('wtd_parse_single_dining')){
    class wtd_parse_single_dining{

	    public $utility;

        function __construct(){
            add_action('the_content', array($this, 'dining_content'), 99);
            //Ajax calls
            add_action('wp_ajax_wtd_build_dining', array($this, 'build_content'));
            add_action('wp_ajax_nopriv_wtd_build_dining', array($this, 'build_content'));
		...
		<script src="<?php echo WTD_PLUGIN_URL;?>/assets/js/parse-1.6.14.js"></script>
	            ...
	            <script type="text/javascript" src="<?php echo WTD_PLUGIN_URL;?>assets/js/single_pages/dining.js"></script><?php
	        ...
	        <div layout="column"><?php
	            ...
	            <div layout="column">
		            <div layout="row" layout-align="center center" layout-margin layout-padding>
	                    <img class="wtd_single_listing_sc_image" src="<?php echo $dining->logoUrl;?>" style="max-width: 200px; max-height: 200px; width: 100%;" />
		            </div>
	                <h3><?php echo $dining->name;?></h3>
	                <p class="wtd_text_bold"><?php
	                    echo $dining->vend_name;?>
	                </p>
	                <p><?php echo $dining->description;?></p>
    ...
    $wtd_parse_single_dining = new wtd_parse_single_dining();
}?>